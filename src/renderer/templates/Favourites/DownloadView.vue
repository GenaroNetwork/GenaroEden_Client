                ...
                <el-table-column width="300" label="">
                    <template slot-scope="scope">
                        <div class="action-cell">
                            <el-button v-if="scope.row.taskState === 2" class="row-action" @click="cancelTask(scope.row)" type="text" size="small"><i class="material-icons">cancel</i></el-button>
                            <el-button v-if="scope.row.taskState === 3 || scope.row.taskState === 4" class="row-action" @click="removeTask(scope.row)" type="text" size="small"><i class="material-icons">delete_sweep</i></el-button>
                        </div>
                    </template>
                </el-table-column>
